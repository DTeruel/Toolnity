...
public class StateMachineGenerator : EditorWindow
{
    ...
    [MenuItem("Tools/Toolnity/State Machine Generator", priority = 3000)]
    public static void ShowWindow()
    {
        var scriptableObjectsEditorWindow = GetWindow<StateMachineGenerator>("State Machine Generator");
        scriptableObjectsEditorWindow.titleContent = new GUIContent(
            "State Machine Generator", 
            EditorGUIUtility.IconContent("d_cs Script Icon").image);
