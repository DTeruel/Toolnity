...
namespace Toolnity
{
	...
	internal static class LoadSceneOnPlay
	{
		...
		private const string EDITOR_PREF_MASTER_SCENE = "LoadSceneOnPlay.MasterScene";
		private const string EDITOR_PREF_PREVIOUS_SCENE = "LoadSceneOnPlay.PreviousScene";
		...
		{
			get => EditorPrefs.GetString(Application.dataPath + EDITOR_PREF_MASTER_SCENE, "Master.unity");
			set => EditorPrefs.SetString(Application.dataPath + EDITOR_PREF_MASTER_SCENE, value);
		}

		private static string PreviousScene
		{
			get => EditorPrefs.GetString(Application.dataPath + EDITOR_PREF_PREVIOUS_SCENE, SceneManager.GetActiveScene().path);
			set => EditorPrefs.SetString(Application.dataPath + EDITOR_PREF_PREVIOUS_SCENE, value);
		}
