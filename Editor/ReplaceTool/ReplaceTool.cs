...
namespace Toolnity
{
    ...
    public class ReplaceTool : EditorWindow
    {
        ...
        [MenuItem("Tools/Toolnity/Replace Tool", priority = 1500)]
        public static void ShowWindow()
        {
            replaceToolWindow = GetWindow<ReplaceTool>("Replace Tool");
            replaceToolWindow.titleContent = new GUIContent("Replace Tool", EditorGUIUtility.IconContent("d_CustomTool").image);
